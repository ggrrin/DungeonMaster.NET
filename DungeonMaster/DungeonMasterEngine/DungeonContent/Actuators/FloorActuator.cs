...
namespace DungeonMasterEngine.DungeonContent.Actuators
{
    public class FloorActuator : ActuatorX
    {
        ...
        public void Trigger(object obj, IEnumerable<object> items, bool entering)
        {
            ...
            {
                item.TryTrigger(this, obj, entering, alreadyContainsParty, alreadyContainsCreature, alreadyContainsGrabable, alreadyContainsThingOfSameType, alreadyContainsThingOfDifferentType);
            }
