...
namespace DungeonMasterEngine.DungeonContent.EntitySupport
{
    public class Champion : Entity
    {
        ...
        public override ISkill GetSkill(ISkillFactory propertyType) => skills.FirstOrDefault(s => s.Factory == propertyType) ?? new EmptySkill();
        ...
        protected virtual void OnPropertyInitialize()
        {
            var load = new LoadProperty(this);
            properties = new IProperty[]
              {
                ...
                new ManaProperty(),
                load,
                new StrengthProperty(),
                new DextrityProperty(load),
                new WisdomProperty(),
                new VitalityProperty(),
                new AntiMagicProperty(),
                new AntiFireProperty(),
                new FoodProperty(),
                new WaterProperty(),
                new LuckProperty(),
              };
