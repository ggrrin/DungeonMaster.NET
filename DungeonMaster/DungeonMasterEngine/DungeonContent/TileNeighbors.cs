...
namespace DungeonMasterEngine.DungeonContent
{
    ...
    public class TileNeighbors : INeighbors<ITile>
    {

        public TileNeighbors(Tile north, Tile south, Tile east, Tile west)
        {
            North = north;
            South = south;
            East = east;
        ...
        public TileNeighbors(TileNeighbors neigbours)
        {
