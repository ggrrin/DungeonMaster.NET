...
{
    class ThrowAttakc : MeleeAttack<ThrowActionFactory>
    {
        public IStorageType P684_i_SlotIndex { get; }

        public ThrowAttakc(ThrowActionFactory factoryBase, ILiveEntity attackProvider, IStorageType p684ISlotIndex) : base(factoryBase, attackProvider)
        {
