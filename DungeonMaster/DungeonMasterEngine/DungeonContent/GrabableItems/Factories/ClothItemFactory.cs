...
namespace DungeonMasterEngine.DungeonContent.GrabableItems.Factories
{
    public class ClothItemFactory : GrabableItemFactoryBase
    {
        ...
        public ClothItemFactory(string name, int weight, IEnumerable<IActionFactory> attackCombo, IEnumerable<IStorageType> carryLocation, int armorStrength, int sharpResistance, bool isShield, IRenderer renderer) : base(name, weight, attackCombo, carryLocation, renderer)
        {
