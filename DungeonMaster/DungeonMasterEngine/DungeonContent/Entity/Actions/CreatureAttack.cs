...
using static DungeonMasterEngine.DungeonContent.Entity.Actions.CreatureAttackType;

namespace DungeonMasterEngine.DungeonContent.Entity.Actions
{
    public class CreatureAttack : AttackBase
    {
        ...
        public CreatureAttack(Creature attackProvider)
        {
        ...
        int F321_AA29_CHAMPION_AddPendingDamageAndWounds_GetDamage(ILiveEntity P662_i_ChampionIndex, int P663_i_Attack, ICollection<IStorageType> P664_i_AllowedWounds, CreatureAttackType P665_i_AttackType)
        {
            ...
            if (P665_i_AttackType != C0_ATTACK_NORMAL)
            {
                ...
                //for (L0978_ui_WoundCount = 0, A0976_i_WoundIndex = C00_SLOT_READY_HAND, L0977_ui_Defense = 0; A0976_i_WoundIndex <= C05_SLOT_FEET; A0976_i_WoundIndex++)
                {
                    ...
                    {
                        L0978_ui_WoundCount++;
                        L0977_ui_Defense += F313_xxxx_CHAMPION_GetWoundDefense(P662_i_ChampionIndex, new WoundInfo(P665_i_AttackType == C4_ATTACK_SHARP, bodyPart.Type));
