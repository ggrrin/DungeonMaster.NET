...
namespace DungeonMasterEngine.Builders
{
    public partial class OldDungeonBuilder : IDungonBuilder
    {
        class ChampoinBuilder
        {
            ...
            public ChampoinBuilder(OldDungeonBuilder builder, WallTile champoinWall, Tile currentTile)
            {
            ...
            private string FindChampionDescriptor()
            {
                ...
                var texts = (from i in builder.map[currentTile.GridPosition.X, currentTile.GridPosition.Y].Items
