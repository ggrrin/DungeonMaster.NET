...
{
    public class MeleeAttack : MeleeAttack<HumanActionFactoryBase>
    {
        public MeleeAttack(HumanActionFactoryBase factoryBase, ILiveEntity attackProvider) : base(factoryBase, attackProvider) {}
    }

    public class MeleeAttack<TFactory> : HumanAttack<TFactory> where TFactory : HumanActionFactoryBase
    {
        ...
        public MeleeAttack(TFactory factoryBase, ILiveEntity attackProvider) : base(factoryBase, attackProvider) { }
