...
namespace DungeonMasterEngine.Builders.ActuatorCreators
{
    ...
    public interface IFloorActuatorCreator
    {
        Task<FloorActuator> GetFloorActuator(IEnumerable<ActuatorItemData> actuators);
    }

    public class FloorActuatorCreator : ActuatorCreatorBase, IFloorActuatorCreator
    {
        ...
        protected MapDirection? GetDirection(int data)
        {
            switch (data)
            {
                case 0:
